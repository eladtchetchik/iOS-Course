...
- (void)viewDidLoad
    ...
    names = @[@"Anders Celsius", @"Amedeo Avogadro", @"Blaise Pascal", @"Christian Doppler", @"Danial ernoulli", @"Ernst Rutherford", @"Georg Ohm", @"Enrico Fermi", @"Joseph Fourier", @"Leonard Euler", @"Marie Curie" ];
